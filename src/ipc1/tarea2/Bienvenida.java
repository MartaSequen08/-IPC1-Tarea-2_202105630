...
public class Bienvenida extends javax.swing.JFrame {
   ...
   Usuario unico[];
    ...
    public Bienvenida(Usuario unico[]) {
       this.unico=unico;
        initComponents();
       infousuario();
    }
       public void infousuario(){
           //matriz
           String table[][] = new String [unico.length][3];
           
           //llenado de matriz
           for(int i=0;i<unico.length;i++){
               table[i][0]= unico[i].getName();
               table[i][1]= unico[i].getApellido();
               table[i][2]= unico[i].getCarnet();
           }
